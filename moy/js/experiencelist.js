...
$(function (){
	...
	function left()
	{
		var URL='http://192.168.1.62:8080/shaping/experience/queryExperListPc?pvSort=3';
		var number=1;
		$.ajax({
			...
			dataType:'jsonp',
			jsonp:"callback",
		    jsonpCallback:"queryExperListPc",
		    success:function(data){
				...
				else
				{
					...
					for (var i=0; i<aList.length; i++)
					{
                        ...
                        // console.log(mo);
						// console.log(333);
						$('.ml_list').append('<li><a href="../pcpage/experience.html?id='+aList[i].id+'"'
	                        +'<div class="pic_box">'
	                            +'<img src="'+'http://121.43.229.113:8081/shaping'+aList[i].homePic+'" alt="">'
	                        ...
	                        +'<div class="ml_details">'
	                            +'<p>'+aList[i].noteTitle+'</p>'
	                            +'<a href="../pcpage/experience.html?id='+aList[i].id+'">继续阅读&gt;&gt;</a>'
	                        +'</div>'
	                	+'</a></li>');
					}
	        ...
	        success:function (data){
				...
				else
				{
					...
					{	
						...
						$('#hot_act').append('<li><a href="../pcpage/experience.html?id='+diaryLists[i].id+'">'
					...
					for (var j=2; j<4; j++)
					{
						...
						// var time=diaryLists[i].createTime;
                            // time=time.substring(0,9);
						$('#m_boutique').append('<li><a href="../pcpage/experience.html?id='+diaryLists[j].id+'">'
